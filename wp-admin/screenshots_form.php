...
require_once('../wp-content/themes/formationpro-child/screenshot_mail_template.php');
...
if( isset( $_POST[ 'requester_email' ]) && !empty( $_POST[ 'requester_email' ])) {
	...
	$template_html = str_replace('$campaign_name', $_POST['campaign_name'], $template_html);
